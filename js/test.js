$(document).ready(function () {
    ...
    $("#education10_details_next").click(function () {
        ...
        if ($.trim($("#mark_lang_10").val()).length == 0) {
            ...
            if (
                $.trim($("#mark_lang_10").val()) >= 0 &&
                $.trim($("#mark_lang_10").val()) <= 100
            ) {
                error_mark_lang_10 = "";
                $("#error_mark_lang_10").text(error_mark_lang_10);
        ...
        if ($.trim($("#mark_englang_10").val()).length == 0) {
            ...
            if (
                $.trim($("#mark_englang_10").val()) >= 0 &&
                $.trim($("#mark_englang_10").val()) <= 100
            ) {
        ...
        if ($.trim($("#mark_maths_10").val()).length == 0) {
            ...
            if (
                $.trim($("#mark_maths_10").val()) >= 0 &&
                $.trim($("#mark_maths_10").val()) <= 100
            ) {
                error_mark_maths_10 = "";
                $("#error_mark_maths_10").text(error_mark_maths_10);
        ...
        if ($.trim($("#mark_science_10").val()).length == 0) {
            ...
            if (
                $.trim($("#mark_science_10").val()) >= 0 &&
                $.trim($("#mark_science_10").val()) <= 100
            ) {
        ...
        if ($.trim($("#mark_socscience_10").val()).length == 0) {
            ...
            if (
                $.trim($("#mark_socscience_10").val()) >= 0 &&
                $.trim($("#mark_socscience_10").val()) <= 100
            ) {
        ...
        if ($.trim($("#mark_tot_10").val()).length == 0) {
            ...
            if (
                $.trim($("#mark_tot_10").val()) >= 0 &&
                $.trim($("#mark_tot_10").val()) <= 500
            ) {
                error_mark_tot_10 = "";
                $("#error_mark_tot_10").text(error_mark_tot_10);
        ...
        if ($.trim($("#coures_details").val()) == "Choose") {
            error_coures_details = "This field is required";
            $("#error_coures_details").text(error_coures_details);
            $("#coures_details").addClass("has-error");
        } else {
            error_coures_details = "";
            $("#error_coures_details").text(error_coures_details);
            $("#coures_details").removeClass("has-error");
        }
        ...
        return false;
            ...
            if ($.trim($("#coures_details").val()) == "Diploma") {
                console.log('trueeee')
                $("#education_10_details").removeClass("active active_tab1");
                $("#education10_details").removeClass("active");
                $("#education_10_details").addClass("inactive_tab1");
                $("#diploma_ug_details").removeClass("inactive_tab1");
                $("#diploma_ug_details").addClass("active_tab1 active");
                $("#diploma_details").addClass("active in");
            } else {
                console.log('falseee')
                $("#education_10_details").removeClass("active active_tab1");
                $("#education10_details").removeClass("active");
    ...
    $("#diploma_details_next").click(function () {
        var error_course_details = "";
        var error_collage_name = "";
        var error_diplomacity = "";
        var error_collage_regiontype = "";
        var error_year_collage = "";
        var error_percentage = "";

        if ($.trim($("#course_details").val()) == "Choose") {
            error_course_details = "This field is required";
            $("#error_course_details").text(error_course_details);
            $("#course_details").addClass("has-error");
        } else {
            error_course_details = "";
            $("#error_course_details").text(error_course_details);
            $("#course_details").removeClass("has-error");
        }

        if ($.trim($("#collage_name").val()).length == 0) {
            error_collage_name = "This field is required";
            $("#error_collage_name").text(error_collage_name);
            $("#collage_name").addClass("has-error");
        } else {
            error_scl10 = "";
            $("#error_scl10").text(error_scl10);
            $("#collage_name").removeClass("has-error");
        }

        if ($.trim($("#diplomacity").val()) == "Choose") {
            error_diplomacity = "This field is required";
            $("#error_diplomacity").text(error_diplomacity);
            $("#diplomacity").addClass("has-error");
        } else {
            error_diplomacity = "";
            $("#error_diplomacity").text(error_diplomacity);
            $("#diplomacity").removeClass("has-error");
        }
        if ($.trim($("#collage_regiontype").val()) == "Choose") {
            error_collage_regiontype = "This field is required";
            $("#error_collage_regiontype").text(error_collage_regiontype);
            $("#collage_regiontype").addClass("has-error");
        } else {
            error_collage_regiontype = "";
            $("#error_collage_regiontype").text(error_collage_regiontype);
            $("#collage_regiontype").removeClass("has-error");
        }       
        
        if ($.trim($("#year_collage").val()) == "Option") {
            error_year_collage = "This field is required";
            $("#error_year_collage").text(error_year_collage);
            $("#year_collage").addClass("has-error");
        } else {
            error_year_collage = "";
            $("#error_year_collage").text(error_year_collage);
            $("#year_collage").removeClass("has-error");
        }

        if ($.trim($("#percentage").val()).length == 0) {
            error_percentage = "This field is required";
            $("#error_percentage").text(error_percentage);
            $("#percentage").addClass("has-error");
        } else {
            if (
                $.trim($("#percentage").val()) >= 0 &&
                $.trim($("#percentage").val()) <= 100
            ) {
                error_percentage = "";
                $("#error_percentage").text(error_percentage);
                $("#percentage").removeClass("has-error");
            } else {
                error_percentage = "Must be a number less than or equal to 100";
                $("#error_percentage").text(error_percentage);
                $("#percentage").addClass("has-error");
            }
        }
        ...
        error_percentage != "" 
            ...
            $("#diploma_ug_details").removeClass("active active_tab1");
            $("#diploma_details").removeClass("active in");
            $("#diploma_ug_details").addClass("inactive_tab1");
            ...
            $("#diploma_ug_details").removeClass("active active_tab1");
            $("#diploma_details").removeClass("active");
            $("#diploma_ug_details").addClass("inactive_tab1");
            $("#completions").removeClass("inactive_tab1");
            $("#completions").addClass("active_tab1 active");
            $("#endcompletion").addClass("active in");
            $(window).scrollTop(0);
        }
    });
        
    $("#diploma_details_previous").click(function () {
    ...
    $("#education12_details_next").click(function () {
        ...
        if ($.trim($("#mark_lang_12").val()).length == 0) {
            ...
            if (
            $.trim($("#mark_lang_12").val()) >= 0 &&
            $.trim($("#mark_lang_12").val()) <= 100
            ) {
            error_mark_lang_12 = "";
            $("#error_mark_lang_12").text(error_mark_lang_12);
        ...
        if ($.trim($("#mark_englang_12").val()).length == 0) {
            ...
            if (
            $.trim($("#mark_englang_12").val()) >= 0 &&
            $.trim($("#mark_englang_12").val()) <= 100
            ) {
        ...
        if (
            ...
            $.trim($("#sub12").val()) == "Botany / Chemistry / Physics / Zoology"
            ) {
                $("#education_12_details").removeClass("active active_tab1");
                $("#education12_details").removeClass("active");
                $("#education_12_details").addClass("inactive_tab1");
    ...
    if ($.trim($("#mark_maths1_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_maths1_12").val()) >= 0 &&
        $.trim($("#mark_maths1_12").val()) <= 100
        ) {
    ...
    if ($.trim($("#mark_phy1_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_phy1_12").val()) >= 0 &&
        $.trim($("#mark_phy1_12").val()) <= 100
        ) {
        error_mark_phy1_12 = "";
        $("#error_mark_phy1_12").text(error_mark_phy1_12);
    ...
    if ($.trim($("#mark_chem1_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_chem1_12").val()) >= 0 &&
        $.trim($("#mark_chem1_12").val()) <= 100
        ) {
        error_mark_chem1_12 = "";
        $("#error_mark_chem1_12").text(error_mark_chem1_12);
    ...
    if ($.trim($("#mark_stat1_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_stat1_12").val()) >= 0 &&
        $.trim($("#mark_stat1_12").val()) <= 100
        ) {
        error_mark_stat1_12 = "";
        $("#error_mark_stat1_12").text(error_mark_stat1_12);
    ...
    if ($.trim($("#mark_tot1_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_tot1_12").val()) >= 0 &&
        $.trim($("#mark_tot1_12").val()) <= 600
        ) {
        error_mark_tot1_12 = "";
        $("#error_mark_tot1_12").text(error_mark_tot1_12);
    ...
    if ($.trim($("#mark_comm2_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_comm2_12").val()) >= 0 &&
        $.trim($("#mark_comm2_12").val()) <= 100
        ) {
        error_mark_comm2_12 = "";
        $("#error_mark_comm2_12").text(error_mark_comm2_12);
    ...
    if ($.trim($("#mark_eco2_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_eco2_12").val()) >= 0 &&
        $.trim($("#mark_eco2_12").val()) <= 100
        ) {
        error_mark_eco2_12 = "";
        $("#error_mark_eco2_12").text(error_mark_eco2_12);
    ...
    if ($.trim($("#mark_acc2_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_acc2_12").val()) >= 0 &&
        $.trim($("#mark_acc2_12").val()) <= 100
        ) {
        error_mark_acc2_12 = "";
        $("#error_mark_acc2_12").text(error_mark_acc2_12);
    ...
    if ($.trim($("#mark_his2_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_his2_12").val()) >= 0 &&
        $.trim($("#mark_his2_12").val()) <= 100
        ) {
        error_mark_his2_12 = "";
        $("#error_mark_his2_12").text(error_mark_his2_12);
    ...
    if ($.trim($("#mark_tot2_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_tot2_12").val()) >= 0 &&
        $.trim($("#mark_tot2_12").val()) <= 600
        ) {
        error_mark_tot2_12 = "";
        $("#error_mark_tot2_12").text(error_mark_tot2_12);
    ...
    if ($.trim($("#mark_comm3_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_comm3_12").val()) >= 0 &&
        $.trim($("#mark_comm3_12").val()) <= 100
        ) {
        error_mark_comm3_12 = "";
        $("#error_mark_comm3_12").text(error_mark_comm3_12);
    ...
    if ($.trim($("#mark_eco3_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_eco3_12").val()) >= 0 &&
        $.trim($("#mark_eco3_12").val()) <= 100
        ) {
        error_mark_eco3_12 = "";
        $("#error_mark_eco3_12").text(error_mark_eco3_12);
    ...
    if ($.trim($("#mark_acc3_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_acc3_12").val()) >= 0 &&
        $.trim($("#mark_acc3_12").val()) <= 100
        ) {
        error_mark_acc3_12 = "";
        $("#error_mark_acc3_12").text(error_mark_acc3_12);
    ...
    if ($.trim($("#mark_bm3_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_bm3_12").val()) >= 0 &&
        $.trim($("#mark_bm3_12").val()) <= 100
        ) {
        error_mark_bm3_12 = "";
        $("#error_mark_bm3_12").text(error_mark_bm3_12);
    ...
    if ($.trim($("#mark_tot3_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_tot3_12").val()) >= 0 &&
        $.trim($("#mark_tot3_12").val()) <= 600
        ) {
        error_mark_tot3_12 = "";
        $("#error_mark_tot3_12").text(error_mark_tot3_12);
    ...
    if ($.trim($("#mark_comm4_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_comm4_12").val()) >= 0 &&
        $.trim($("#mark_comm4_12").val()) <= 100
        ) {
        error_mark_comm4_12 = "";
        $("#error_mark_comm4_12").text(error_mark_comm4_12);
    ...
    if ($.trim($("#mark_eco4_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_eco4_12").val()) >= 0 &&
        $.trim($("#mark_eco4_12").val()) <= 100
        ) {
        error_mark_eco4_12 = "";
        $("#error_mark_eco4_12").text(error_mark_eco4_12);
    ...
    if ($.trim($("#mark_acc4_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_acc4_12").val()) >= 0 &&
        $.trim($("#mark_acc4_12").val()) <= 100
        ) {
        error_mark_acc4_12 = "";
        $("#error_mark_acc4_12").text(error_mark_acc4_12);
    ...
    if ($.trim($("#mark_ps4_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_ps4_12").val()) >= 0 &&
        $.trim($("#mark_ps4_12").val()) <= 100
        ) {
        error_mark_ps4_12 = "";
        $("#error_mark_ps4_12").text(error_mark_ps4_12);
    ...
    if ($.trim($("#mark_tot4_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_tot4_12").val()) >= 0 &&
        $.trim($("#mark_tot4_12").val()) <= 600
        ) {
        error_mark_tot4_12 = "";
        $("#error_mark_tot4_12").text(error_mark_tot4_12);
    ...
    if ($.trim($("#mark_comm5_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_comm5_12").val()) >= 0 &&
        $.trim($("#mark_comm5_12").val()) <= 100
        ) {
        error_mark_comm5_12 = "";
        $("#error_mark_comm5_12").text(error_mark_comm5_12);
    ...
    if ($.trim($("#mark_eco5_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_eco5_12").val()) >= 0 &&
        $.trim($("#mark_eco5_12").val()) <= 100
        ) {
        error_mark_eco5_12 = "";
        $("#error_mark_eco5_12").text(error_mark_eco5_12);
    ...
    if ($.trim($("#mark_acc5_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_acc5_12").val()) >= 0 &&
        $.trim($("#mark_acc5_12").val()) <= 100
        ) {
        error_mark_acc5_12 = "";
        $("#error_mark_acc5_12").text(error_mark_acc5_12);
    ...
    if ($.trim($("#mark_stat5_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_stat5_12").val()) >= 0 &&
        $.trim($("#mark_stat5_12").val()) <= 100
        ) {
        error_mark_stat5_12 = "";
        $("#error_mark_stat5_12").text(error_mark_stat5_12);
    ...
    if ($.trim($("#mark_tot5_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_tot5_12").val()) >= 0 &&
        $.trim($("#mark_tot5_12").val()) <= 600
        ) {
        error_mark_tot5_12 = "";
        $("#error_mark_tot5_12").text(error_mark_tot5_12);
    ...
    if ($.trim($("#mark_maths6_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_maths6_12").val()) >= 0 &&
        $.trim($("#mark_maths6_12").val()) <= 100
        ) {
    ...
    if ($.trim($("#mark_phy6_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_phy6_12").val()) >= 0 &&
        $.trim($("#mark_phy6_12").val()) <= 100
        ) {
        error_mark_phy6_12 = "";
        $("#error_mark_phy6_12").text(error_mark_phy6_12);
    ...
    if ($.trim($("#mark_chem6_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_chem6_12").val()) >= 0 &&
        $.trim($("#mark_chem6_12").val()) <= 100
        ) {
        error_mark_chem6_12 = "";
        $("#error_mark_chem6_12").text(error_mark_chem6_12);
    ...
    if ($.trim($("#mark_bio6_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_bio6_12").val()) >= 0 &&
        $.trim($("#mark_bio6_12").val()) <= 100
        ) {
        error_mark_bio6_12 = "";
        $("#error_mark_bio6_12").text(error_mark_bio6_12);
    ...
    if ($.trim($("#mark_tot6_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_tot6_12").val()) >= 0 &&
        $.trim($("#mark_tot6_12").val()) <= 600
        ) {
        error_mark_tot6_12 = "";
        $("#error_mark_tot6_12").text(error_mark_tot6_12);
    ...
    if ($.trim($("#mark_zoo7_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_zoo7_12").val()) >= 0 &&
        $.trim($("#mark_zoo7_12").val()) <= 100
        ) {
        error_mark_zoo7_12 = "";
        $("#error_mark_zoo7_12").text(error_mark_zoo7_12);
    ...
    if ($.trim($("#mark_phy7_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_phy7_12").val()) >= 0 &&
        $.trim($("#mark_phy7_12").val()) <= 100
        ) {
        error_mark_phy7_12 = "";
        $("#error_mark_phy7_12").text(error_mark_phy7_12);
    ...
    if ($.trim($("#mark_chem7_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_chem7_12").val()) >= 0 &&
        $.trim($("#mark_chem7_12").val()) <= 100
        ) {
        error_mark_chem7_12 = "";
        $("#error_mark_chem7_12").text(error_mark_chem7_12);
    ...
    if ($.trim($("#mark_bot7_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_bot7_12").val()) >= 0 &&
        $.trim($("#mark_bot7_12").val()) <= 100
        ) {
        error_mark_bot7_12 = "";
        $("#error_mark_bot7_12").text(error_mark_bot7_12);
    ...
    if ($.trim($("#mark_tot7_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_tot7_12").val()) >= 0 &&
        $.trim($("#mark_tot7_12").val()) <= 600
        ) {
        error_mark_tot7_12 = "";
        $("#error_mark_tot7_12").text(error_mark_tot7_12);
    ...
    if ($.trim($("#mark_maths8_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_maths8_12").val()) >= 0 &&
        $.trim($("#mark_maths8_12").val()) <= 100
        ) {
    ...
    if ($.trim($("#mark_phy8_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_phy8_12").val()) >= 0 &&
        $.trim($("#mark_phy8_12").val()) <= 100
        ) {
        error_mark_phy8_12 = "";
        $("#error_mark_phy8_12").text(error_mark_phy8_12);
    ...
    if ($.trim($("#mark_chem8_12").val()).length == 0) {
        ...
        if (
        $.trim($("#mark_chem8_12").val()) >= 0 &&
        $.trim($("#mark_chem8_12").val()) <= 100
        ) {
        error_mark_chem8_12 = "";
        $("#error_mark_chem8_12").text(error_mark_chem8_12);
    ...
    if ($.trim($("#mark_cs8_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_cs8_12").val()) >= 0 &&
        $.trim($("#mark_cs8_12").val()) <= 100
        ) {
        error_mark_cs8_12 = "";
        $("#error_mark_cs8_12").text(error_mark_cs8_12);
    ...
    if ($.trim($("#mark_tot8_12").val()).length == 0) {
        ...
        if (
        $.trim($("mark_tot8_12").val()) >= 0 &&
        $.trim($("#mark_tot8_12").val()) <= 600
        ) {
        error_mark_tot8_12 = "";
        $("#error_mark_tot8_12").text(error_mark_tot8_12);
    ...
    $("#major9_next").click(function () {
        ...
        if ($.trim($("#mark_acc9_12").val()).length == 0) {
            ...
            if (
            $.trim($("#mark_acc9_12").val()) >= 0 &&
            $.trim($("#maracc9_12").val()) <= 100
            ) {
            error_mark_acc9_12 = "";
            $("#error_mark_acc9_12").text(error_mark_acc9_12);
        ...
        if ($.trim($("#mark_comm9_12").val()).length == 0) {
            ...
            if (
            $.trim($("#mark_comm9_12").val()) >= 0 &&
            $.trim($("#mark_comm9_12").val()) <= 100
            ) {
            error_mark_comm9_12 = "";
            $("#error_mark_comm9_12").text(error_mark_comm9_12);
        ...
        if ($.trim($("#mark_comp9_12").val()).length == 0) {
            ...
            if (
            $.trim($("#mark_comp9_12").val()) >= 0 &&
            $.trim($("#mark_comp9_12").val()) <= 100
            ) {
            error_mark_comp9_12 = "";
            $("#error_mark_comp9_12").text(error_mark_comp9_12);
        ...
        if ($.trim($("#mark_eco9_12").val()).length == 0) {
            ...
            if (
            $.trim($("mark_eco9_12").val()) >= 0 &&
            $.trim($("#mark_eco9_12").val()) <= 100
            ) {
            error_mark_eco9_12 = "";
            $("#error_mark_eco9_12").text(error_mark_eco9_12);
        ...
        if ($.trim($("#mark_tot9_12").val()).length == 0) {
            ...
            if (
            $.trim($("mark_tot9_12").val()) >= 0 &&
            $.trim($("#mark_tot9_12").val()) <= 600
            ) {
            error_mark_tot9_12 = "";
            $("#error_mark_tot9_12").text(error_mark_tot9_12);
